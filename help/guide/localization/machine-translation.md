...
1. Fai clic sul Selettore lingua (icona a forma di mondo), quindi scegli una lingua.
   ...
   Il contenuto può essere reso automaticamente nella tua lingua, oppure puoi cliccare su un link per attivare la traduzione. (Questo può verificarsi quando si clicca sul collegamento ipertestuale per tornare alla pagina originale in inglese dalla pagina tradotta. Ti offre la possibilità di visualizzare la pagina tradotta su richiesta.) Puoi tornare in qualsiasi momento alla pagina originale in inglese.
...
Quando il contenuto viene tradotto automaticamente, per impostazione predefinita o per scelta dell’utente, è possibile fornire ad Adobe un feedback sulle traduzioni. In
barra orizzontale azzurra nella parte superiore della pagina, è possibile rispondere &quot;Sì&quot; o &quot;No&quot; alla domanda, &quot;Questa traduzione è stata utile?&quot;. Adobe raccoglie questi dati importanti
...
In futuro, consentiremo di fornire feedback più approfonditi, sotto forma di segnalazione di problemi, proposte di miglioramenti e persino richieste di
lingue aggiuntive. Alcune di queste funzioni sono già disponibili nelle pagine in inglese. A lungo termine, crediamo che questo aiuterà Adobe a migliorare l’utente
esperienza su queste pagine.
